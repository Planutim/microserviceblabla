...
type ClientService interface {
	...
	ProductsRequest(params *ProductsRequestParams, opts ...ClientOption) (*ProductsRequestCreated, error)
...
/*
  DeleteProduct Returns result of deletion
*/
...
/*
  ListSingleProduct Return a list of products from a database
*/
...
/*
  ProductsRequest Returns result of creating
*/
func (a *Client) ProductsRequest(params *ProductsRequestParams, opts ...ClientOption) (*ProductsRequestCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewProductsRequestParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "productsRequest",
		Method:             "POST",
		...
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &ProductsRequestReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	success, ok := result.(*ProductsRequestCreated)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for productsRequest: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
